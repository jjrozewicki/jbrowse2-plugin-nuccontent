...
var default_1 = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
  ...
  _createClass(default_1, [{
    ...
    value: function getFeatures(query, opts) {
      ...
      var gRegExp = readConfObject(this.config, ['gRegExp']);
      var cRegExp = readConfObject(this.config, ['cRegExp']);
      var ValidNucRegExp = readConfObject(this.config, ['ValidNucRegExp']);
...
function stateModelFactory(pluginManager, configSchema) {
  ...
  function SetWindowDlg(props) {
    ...
    var _useState = useState(model.adapterConfig.windowSize),
